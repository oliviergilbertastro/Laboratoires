...
Na22_data_mobile = load_text(sources[1])
Na22_data_fixe = load_text(sources[2])
...
def fit_gaussian(data, title, source_pic, p0=None, lower_bound=0):
    ...
    plt.plot(x, gaussienne(x, *params), label=f"{title}", color='red', linestyle='--',  linewidth=2)
    plt.plot(x, linear(x, *(B, C)), label=f"Portion linéaire", color='black', linestyle='-', linewidth=2)
...
Na22_data_511_fixe = Na22_data_fixe[Na22_511_bounds[0]:Na22_511_bounds[1]]
Na22_data_1275_fixe = Na22_data_fixe[Na22_1275_bounds[0]:Na22_1275_bounds[1]]

Na22_data_511_mobile = Na22_data_mobile[Na22_511_bounds[0]:Na22_511_bounds[1]]
Na22_data_1275_mobile = Na22_data_mobile[Na22_1275_bounds[0]:Na22_1275_bounds[1]]
...
position_Na22_511_fixe, FWHM_Na22_511_fixe = fit_gaussian(Na22_data_511_fixe, "Ajustement Gaussien", 'Na22_511_fixe',p0=[max(Na22_data_511_fixe), np.argmax(Na22_data_511_fixe), 10, 0, 0], lower_bound=Na22_511_bounds[0])
position_Na22_1275_fixe, FWHM_Na22_1275_fixe = fit_gaussian(Na22_data_1275_fixe, "Ajustement Gaussien", 'Na22_1275_fixe',p0=[max(Na22_data_1275_fixe), np.argmax(Na22_data_1275_fixe), 10, 0, 0], lower_bound=Na22_1275_bounds[0])


position_Na22_511_mobile, FWHM_Na22_511_mobile = fit_gaussian(Na22_data_511_mobile, "Ajustement Gaussien", 'Na22_511_mobile',p0=[max(Na22_data_511_mobile), np.argmax(Na22_data_511_mobile), 10, 0, 0], lower_bound=Na22_511_bounds[0])
position_Na22_1275_mobile, FWHM_Na22_1275_mobile = fit_gaussian(Na22_data_1275_mobile, "Ajustement Gaussien", 'Na22_1275_mobile',p0=[max(Na22_data_1275_mobile), np.argmax(Na22_data_1275_mobile), 10, 0, 0], lower_bound=Na22_1275_bounds[0])
...
energies*=1000
energies = np.append(energies, (511, 1275))
positions = np.append(positions, (position_Na22_511_fixe, position_Na22_1275_fixe))
fwhm_x = np.append(fwhm_x, (FWHM_Na22_511_fixe, FWHM_Na22_1275_fixe))
# Affichage des résultats avec valeur absolue de l'écart et de l'écart en %
for i in range(len(energies)):
    position_ajustee = positions[i] * pente+b
    fwhm_ajuste = fwhm_x[i] * pente+b
