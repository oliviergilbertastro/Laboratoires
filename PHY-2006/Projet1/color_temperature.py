...
def polynomial(x,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10):
    return c1+c2*x+c3*x**2+c4*x**3+c5*x**4+c6*x**5+c7*x**6+c8*x**7#+c9*x**8+c10*x**9
...
y_fit_red = polynomial(x_fit, resr[0], resr[1], resr[2], resr[3], resr[4], resr[5], resr[6], resr[7], resr[8], resr[9])
...
y_fit_green = polynomial(x_fit, resg[0], resg[1], resg[2], resg[3], resg[4], resg[5], resg[6], resg[7], resg[8], resg[9])
...
y_fit_blue = polynomial(x_fit, resb[0], resb[1], resb[2], resb[3], resb[4], resb[5], resb[6], resb[7], resb[8], resb[9])
